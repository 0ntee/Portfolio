...
CategoryTechnologies & Skills
****Data & Classical ML****
Python (Pandas, NumPy, Scikit-learn), SQL (queries, window functions, aggregations)
****Deep Learning & GenAI****
Backpropagation from scratch, Transformers architecture, Vector Embeddings, LangGraph, Llama.cpp
****Infrastructure & Safety****
Linux Systems, Network Namespaces (unshare), Process Isolation, Bash, Makefiles, C (pointers, memory management)
****Data Visualization****
Matplotlib, Seaborn, Custom ASCII-driven CLI logging engines
...
Every subdirectory contains its own standalone README.md with deep-dive technical overviews, architectural charts, and live execution traces. 

To review the code execution locally: 
